...
users:
  - character: "Vegeta (Super)"
    ...
    category: "Short-range energy attack"
    notes: "SPM2"
summary: "Short-range energy attack-class super · 1 user(s) · ki cost 20,000"
...
**Gamma Burst Flash** is a **Short-range energy attack**-class Super (Blast 2) costing **20,000 ki energy**.
