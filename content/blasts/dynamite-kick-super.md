...
users:
  - character: "Mr. Satan"
    ...
    tags:
      - "Played after a hit"
    notes: "SPM1"
summary: "Rush-class super · 1 user(s) · ki cost 30,000 · datamined damage up to 8,500"
...
**Dynamite Kick** is a **Rush**-class Super (Blast 2) costing **30,000 ki energy**.
- **Played after a hit** — connects as a follow-up after the initial hit lands *[datamined]*
- **Datamined power: 8,500** (per-hit datamined Power/BeamPower where the asset overrides defaults — projectile, beam, or melee — vs the 40,000-HP standard cast; chip in the table) *[datamined]*
