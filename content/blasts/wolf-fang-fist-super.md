...
users:
  - character: "Yamcha"
    ...
    tags:
      - "Played after a hit"
    notes: "SPM2"
summary: "Rush-class super · 1 user(s) · ki cost 30,000 · datamined damage up to 6,700"
...
**Wolf Fang Fist** is a **Rush**-class Super (Blast 2) costing **30,000 ki energy**.
- **Played after a hit** — connects as a follow-up after the initial hit lands *[datamined]*
- **Datamined power: 6,700** (per-hit datamined Power/BeamPower where the asset overrides defaults — projectile, beam, or melee — vs the 40,000-HP standard cast; chip in the table) *[datamined]*
