...
category: "pve"
players: "1 (vs CPU)"
access: "Main Menu → Episode Battle"
rewards:
  - "15,000 Zeni per new mission on first clear"
  - "First-clear unique rewards (outfits, character unlocks, illustrations); duplicates auto-convert to Zeni"
  - "300,000 Zeni farm: replay 'Super Saiyan Goku Awakens!' (Goku (Z-Mid) Outfit 3 → 300k on each replay)"
values:
  - label: "Campaigns (protagonists)"
    value: "8"
    tag: "official"
  ...
  - label: "Minor What-If alternate stages"
    value: "~35"
    tag: "community"
  - label: "Zeni per new mission (first clear)"
    value: "15,000"
    tag: "community"
...
|---|---|---|---|
| 1 | [[episode-goku\|Goku]] | Ch. 1–7 (all 7; longest) | From start |
| 2 | [[episode-vegeta\|Vegeta]] | Ch. 2,3,4 | From start |
| 3 | [[episode-gohan\|Gohan]] | Ch. 3,4,5,6,7 | From start |
| 4 | [[episode-piccolo\|Piccolo]] | Ch. 1,2,3,4 | From start |
| 5 | [[episode-frieza\|Frieza]] | Ch. 2,3,5,7 | From start |
| 6 | [[episode-goku-black\|Goku Black]] | Ch. 6 | From start |
| 7 | [[episode-future-trunks\|Future Trunks]] | Ch. 6,7 | **Beat Goku's saga** |
| 8 | [[episode-jiren\|Jiren]] | Ch. 7 | **Beat Goku's saga** |

> Confirmed protagonist list (Bandai): Goku, Vegeta, Gohan, Piccolo, Frieza, Goku Black, Future Trunks, Jiren — **not** Krillin. No DLC has added a new Episode-Battle campaign through June 2026.

## Rewards & objectives

- **15,000 Zeni** per *new* mission on first clear.
- First-clear unique rewards (outfits, character unlocks, illustrations). Already-owned rewards **auto-convert to Zeni**.
- **Best farm:** replay **"Super Saiyan Goku Awakens!"** (Namek arc, Goku's campaign) — its first-clear reward **Goku (Z-Mid) Outfit 3** converts to **300,000 Zeni** on every subsequent replay.
- Each mission has a **primary** + **secondary** objective; secondary-objective difficulty can be eased with a **Dragon Orb** (granted by a Shenron wish after failing an Episode Battle).
